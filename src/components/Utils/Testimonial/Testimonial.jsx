                    ...
                    >
                        <SwiperSlide>
                            <div className='bg-white rounded-sm py-16 px-8 flex flex-col items-center'>
                                ...
                                <p className='w-9/12 mx-auto mb-2 font-semibold text-[17px] text-center'>"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa tempore aut quod quo ad iure mollitia amet aliquid ex quidem eligendi, excepturi dolorem, qui ipsum! Facere, incidunt modi! Eveniet, magni."</p>
                                <div>
                                    <h2 style={{ fontFamily: 'Poppins' }} className='text-2xl font-bold mb-1 text-center text-[#FF1D6A]'>--Jacky Chan</h2>

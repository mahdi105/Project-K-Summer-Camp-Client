...
const Hero = () => {
    ...
    return (
        <div className='pt-12 md:pt-2 pb-10'>
            ...
            >
                <SwiperSlide>
                    <div className='slider-content md:h-[calc(100vh-125px)]'>
                        <div className="md:flex items-center justify-between  mx-auto px-2 md:px-0 lg:px-20 py-4 md:py-16">
                            <div className="slide-content px-10">
                                ...
                                <p data-aos="fade-down" data-aos-once="false" data-aos-duration="800" data-aos-easing="ease-in-out" className='tagline text-[16px] w-9/12 md:text-[17px] mb-[.5rem]'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque voluptatibus illum nostrum officia officiis.</p>
                                <p data-aos="zoom-in" data-aos-once="false" data-aos-duration="400" data-aos-easing="ease-in-out" className='capitalize text-[15px] text-[#01ACFD] mb-[1.8rem] font-bold'>Join our sports community, enjoy your summer</p>
                    ...
                    <div className=' md:h-[calc(100vh-125px)]'>
                        <div className="md:flex items-center justify-between gap-7  mx-auto px-2 md:px-0 lg:px-20 py-4 md:py-16">
                            ...
                            <div className="slide-content px-10">
                                ...
                                <p data-aos="fade-down" data-aos-once="false" data-aos-duration="800" data-aos-easing="ease-in-out" className='tagline text-[16px] w-9/12 md:text-[17px] mb-[.5rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Modi totam, impedit veniam voluptates tenetur obcaecati rerum fugiat exercitationem doloribus unde!</p>
                                <p data-aos="zoom-in" data-aos-once="false" data-aos-duration="400" data-aos-easing="ease-in-out" className='capitalize text-[15px] text-[#01ACFD] mb-[1.8rem] font-bold'>Join our sports community, enjoy your summer</p>
                                <button className='uppercase text-white border border-transparent hover:text-black hover:bg-white hover:border-orange-600 py-2 px-4 rounded-md bg-orange-600 transition-all duration-300'>Join Now</button>
                            </div>
                        </div>
                    ...
                    <div className=' md:h-[calc(100vh-125px)]'>
                        <div className="md:flex items-center justify-between  mx-auto px-2 md:px-0 lg:px-20 py-4 md:py-16">
                            <div className="slide-content px-10">
                                ...
                                <h2 data-aos="fade-left" data-aos-once="false" data-aos-duration="800" data-aos-easing="ease-in-out" className='heading text-[24px] md:text-[62px] leading-[30px] md:leading-[70px] font-[600] mb-4'>Ultra Modern Academy Complex</h2>
                                <p data-aos="fade-down" data-aos-once="false" data-aos-duration="800" data-aos-easing="ease-in-out" className='tagline text-[16px] w-9/12 md:text-[17px] mb-[.5rem]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, similique cumque quis dolorem assumenda quae.</p>
                                <p data-aos="zoom-in" data-aos-once="false" data-aos-duration="400" data-aos-easing="ease-in-out" className='capitalize text-[15px] text-[#01ACFD] mb-[1.8rem] font-bold'>"Join our sports community, enjoy your summer"</p>
                                <button className='uppercase text-white border border-transparent hover:text-black hover:bg-white hover:border-orange-600 py-2 px-4 rounded-md bg-orange-600 transition-all duration-300'>Join Now</button>
                            </div>
                            <div className='w-10/12 mx-auto md:w-7/12'>
